...
var require_object_path = __commonJS({
  "node_modules/.pnpm/object-path@0.11.8/node_modules/object-path/index.js"(exports, module2) {
...
// node_modules/.pnpm/compressorjs@1.2.1/node_modules/compressorjs/dist/compressor.js
var require_compressor = __commonJS({
  "node_modules/.pnpm/compressorjs@1.2.1/node_modules/compressorjs/dist/compressor.js"(exports, module2) {
...
var ImageUploaderSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Base URL").setDesc("Optional base URL to prepend to the image path. Leave empty if the API returns complete URLs.").addText((text) => {
  ...
  async uploadImage(image) {
    return new Promise((resolve, reject) => {
      ...
      import_axios.default.post(this.settings.apiEndpoint, formData, {
        ...
        let url = import_object_path.default.get(res.data, this.settings.imageUrlPath);
